...
const connectDB = async () => {
  try {
    //Método para conectar ao BD
      ...
      //CONECTAR A NUVEM: mongodb+srv://luccabrasies:AxrNsGWBDZoNph5h@gestaodeconhecimento.tnbn4yu.mongodb.net/?retryWrites=true&w=majority
        await mongoose.connect("mongodb+srv://luccabrasies:AxrNsGWBDZoNph5h@gestaodeconhecimento.tnbn4yu.mongodb.net/?retryWrites=true&w=majority", {
